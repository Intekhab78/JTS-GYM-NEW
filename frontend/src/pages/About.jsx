    ...
    <div>
      ...
      <main className="page-shell pt-6 pb-12 md:py-12">
        ...
        <div className="grid gap-4 md:gap-8 md:grid-cols-2">
          <div className="soft-card rounded-3xl p-4 md:p-6">
          ...
          <div className="soft-card rounded-3xl p-4 md:p-6 md:col-span-2 overflow-hidden flex items-center justify-center">
            <img src={sliderJumping} alt="Kids jumping on trampoline" className="w-full h-auto rounded-xl md:rounded-3xl shadow-xl hover:scale-[1.02] transition-transform duration-700" />
          </div>
        </div>
      </main>
      <Footer />
